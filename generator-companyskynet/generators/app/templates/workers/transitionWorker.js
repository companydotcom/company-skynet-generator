export default async ({
  ...
  if (
    ...
    throw new Error(
      "Message did not have the required paameter metadata or parameter eventType within metadata"
    );
  }
  ...
  switch (message.metadata.eventType) {
    ...
    default:
      throw new Error(
        `transitionWorker: ERROR: metadata.eventType not recognized: ${message.metadata.eventType}`
      );
  }
};
